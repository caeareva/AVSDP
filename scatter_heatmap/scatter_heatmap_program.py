...
#
#   Program execution:
#   python3 /Users/carevalo/Desktop/scatter_heatmap/scatter_heatmap_program.py \
#       -i /Users/carevalo/Desktop/scatter_heatmap/test_input_data_1.txt \
#       -o /Users/carevalo/Desktop/scatter_heatmap/scatter_heatmap_test.png \
#       -s /Users/carevalo/Desktop/scatter_heatmap/stylesheet.mplstyle 
#
################################################################################
...
# heatmap function
def heatmap(xList, yList, panel2, xmin, xmax, ymin, ymax, binsize):
  white = (1, 1, 1)
  black = (0, 0, 0)
  ...
  # Add heatmap scale
  color_range = np.linspace(0, 1, 20)
  print(color_range)
  colors = [(1-i, 1-i, 1-i) for i in color_range]
  for color in colors:
    patch = mplpatches.Rectangle((0, colors.index(color) + 0), 1, 21, 
                                linewidth = 0, 
                                facecolor = color)
...
# Plot heatmap: xList, yList, panel, xmin, xmax, ymin, ymax, binsize
